...
| `/etc/agentd/notify.env` | **destinos** dos avisos e formato (lista) | operador | drenador | não | `root:root 0600` — **fora de `/workspace`**; passo a passo em [`NOTIFICATIONS.md`](NOTIFICATIONS.md) |
